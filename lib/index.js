...
/***/ (function(module, exports, __webpack_require__) {
	...
	var InfiniteScroll = (function (_Component) {
	  ...
	  _createClass(InfiniteScroll, [{
	    ...
	    value: function onScrollListener(event) {
	      var target = this.props.height || this.props.scrollTarget ? event.target : document.documentElement.scrollTop ? document.documentElement : document.body;
	...
	InfiniteScroll.propTypes = {
	  ...
	  scrollTarget: _propTypes2['default'].PropTypes.node
	};
